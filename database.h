...
namespace database
{
    ...
    static std::string basic_items_single[10] =
    {
        "AutoMealPouch_Tier5",
        "GrapplingGun4",
        "BowGun_5",
    ...
    // Raw FastTravelPointID -> friendly name. No display-name accessor exists
    // for these, so this stays empty until filled in; missing entries fall
    // back to the raw ID.
    static std::map<std::string, std::string> fastTravelPointNames = {
    };
