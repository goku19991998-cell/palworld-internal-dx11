...
// Allocates executable memory within +/-2GB of target, so a 5-byte relative jmp/call can reach it.
// Needed for manual inline code-cave hooks (AOB patch + trampoline), same technique Cheat Engine uses.
