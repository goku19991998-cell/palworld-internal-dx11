...
void UBP_PalAudioWorldSubsystem_C::OnArenaSequenceChanged(class UPalArenaSequencer* Sequencer, EPalArenaSequenceType PrevType, EPalArenaSequenceType AfterType)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const struct FPalIncidentBroadcastParameter&Param                                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EPalBattleBGMType                       Selection                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_PalAudioWorldSubsystem_C::ResetBossBGMState(EPalBattleBGMType Selection)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PalAudioWorldSubsystem_C", "ResetBossBGMState");

	Params::BP_PalAudioWorldSubsystem_C_ResetBossBGMState Parms{};
