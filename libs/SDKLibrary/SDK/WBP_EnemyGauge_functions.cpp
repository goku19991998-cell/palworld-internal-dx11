...
void UWBP_EnemyGauge_C::SetVisibilityStrongRareMark(ESlateVisibility Visibility)
{
	static class UFunction* Func = nullptr;
...
void UWBP_EnemyGauge_C::SetVisibilitySanityGauge(ESlateVisibility Visibility)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    bVisibleMark                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    bCompleteBonus                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_EnemyGauge_C::SetupCompleteCaptureBonusMark(bool bVisibleMark, bool bCompleteBonus)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_EnemyGauge_C", "SetupCompleteCaptureBonusMark");

	Params::WBP_EnemyGauge_C_SetupCompleteCaptureBonusMark Parms{};

	Parms.bVisibleMark = bVisibleMark;
	Parms.bCompleteBonus = bCompleteBonus;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    IsParts                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_EnemyGauge_C::SetForParts(bool IsParts)
{
	static class UFunction* Func = nullptr;
