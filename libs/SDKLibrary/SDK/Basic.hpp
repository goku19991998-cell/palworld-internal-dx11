...
namespace Offsets
{
	inline int32 GObjects          = 0x094EC210;
	inline int32 AppendString      = 0x034C6150;
	inline int32 GNames            = 0x093F1778;
	inline int32 GWorld            = 0x0965AB80;
	inline int32 ProcessEvent      = 0x03644C40;
