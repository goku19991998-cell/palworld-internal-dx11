...
void UWBP_WorldMap_Icon_Respawn_C::Setup_Internal(class UPalLocationPoint* LocationPoint_Setup_Internal)
{
...
void UWBP_WorldMap_Icon_Respawn_C::GetInvisibleButton(class UWidget** Button_GetInvisibleButton)
{
	static class UFunction* Func = nullptr;
