...
// const TDelegate<void(bool IsOn_0)>&     OnSwitchEvent                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash)

void UWBP_Arena_RuleListContent_0_C::SetupSwitch(bool IsTure, const TDelegate<void(bool IsOn_0)>& OnSwitchEvent)
{
	static class UFunction* Func = nullptr;
