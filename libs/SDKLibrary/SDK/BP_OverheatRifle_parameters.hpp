...
public:
	...
	TDelegate<void(bool bOverHeated, double HeatValue_0)> K2Node_CreateDelegate_OutputDelegate;      // 0x0008(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
