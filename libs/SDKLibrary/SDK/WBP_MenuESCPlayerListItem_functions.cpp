...
struct FEventReply UWBP_MenuESCPlayerListItem_C::OnMouseButtonDown(const struct FGeometry& MyGeometry_OnMouseButtonDown, const struct FPointerEvent& MouseEvent_OnMouseButtonDown)
{
	static class UFunction* Func = nullptr;
...
struct FEventReply UWBP_MenuESCPlayerListItem_C::OnKeyDown(const struct FGeometry& MyGeometry_OnKeyDown, const struct FKeyEvent& InKeyEvent_OnKeyDown)
{
	static class UFunction* Func = nullptr;
