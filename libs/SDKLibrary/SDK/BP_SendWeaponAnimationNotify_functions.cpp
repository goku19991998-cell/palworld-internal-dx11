...
#include "BP_SendWeaponAnimationNotify_classes.hpp"
#include "BP_SendWeaponAnimationNotify_parameters.hpp"
...
bool UBP_SendWeaponAnimationNotify_C::Received_Notify(class USkeletalMeshComponent* MeshComp_Received_Notify, class UAnimSequenceBase* Animation_Received_Notify, const struct FAnimNotifyEventReference& EventReference_Received_Notify) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SendWeaponAnimationNotify_C", "Received_Notify");

	Params::BP_SendWeaponAnimationNotify_C_Received_Notify Parms{};
	...
	return Parms.ReturnValue_Received_Notify;
}
