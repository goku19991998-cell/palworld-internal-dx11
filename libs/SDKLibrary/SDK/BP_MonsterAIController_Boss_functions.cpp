...
void ABP_MonsterAIController_Boss_C::RetargetPlayer()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_MonsterAIController_Boss_C", "RetargetPlayer");
...
void ABP_MonsterAIController_Boss_C::カスタムイベント_1(class APalCharacter* InCharacter)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_MonsterAIController_Boss_C_カスタムイベント_1 Parms{};
