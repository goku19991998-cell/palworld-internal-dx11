...
// Parameters:
// class UPalItemContainer*                Container_OnUpdateInventory                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UBP_InGameMenuBuildModel_C::OnUpdateInventory(class UPalItemContainer* Container_OnUpdateInventory)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Container_OnUpdateInventory = Container_OnUpdateInventory;
