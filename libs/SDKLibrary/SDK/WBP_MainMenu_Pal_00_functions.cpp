...
// Parameters:
// int32                                   FriendshipRank_SetFriendShip                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   FriendshipPoint_SetFriendShip                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_MainMenu_Pal_00_C::SetFriendShip(int32 FriendshipRank_SetFriendShip, int32 FriendshipPoint_SetFriendShip)
{
	...
	Parms.FriendshipRank_SetFriendShip = FriendshipRank_SetFriendShip;
	Parms.FriendshipPoint_SetFriendShip = FriendshipPoint_SetFriendShip;
...
// Parameters:
// int32                                   FoodAmount_SetFoodAmount                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_MainMenu_Pal_00_C::SetFoodAmount(int32 FoodAmount_SetFoodAmount)
{
	static class UFunction* Func = nullptr;
	...
	Parms.FoodAmount_SetFoodAmount = FoodAmount_SetFoodAmount;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EPalElementType                         type1_SetElementType                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// EPalElementType                         type2_SetElementType                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_MainMenu_Pal_00_C::SetElementType(EPalElementType type1_SetElementType, EPalElementType type2_SetElementType)
{
	static class UFunction* Func = nullptr;
	...
	Parms.type1_SetElementType = type1_SetElementType;
	Parms.type2_SetElementType = type2_SetElementType;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    bAwaked_SetAwakening                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_MainMenu_Pal_00_C::SetAwakening(bool bAwaked_SetAwakening)
{
	static class UFunction* Func = nullptr;
	...
	Parms.bAwaked_SetAwakening = bAwaked_SetAwakening;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const TMap<EPalWorkSuitability, int32>& WorkSuitabilities_Set_Work_Suitability                 (BlueprintVisible, BlueprintReadOnly, Parm)

void UWBP_MainMenu_Pal_00_C::Set_Work_Suitability(const TMap<EPalWorkSuitability, int32>& WorkSuitabilities_Set_Work_Suitability)
{
	static class UFunction* Func = nullptr;
	...
	Parms.WorkSuitabilities_Set_Work_Suitability = std::move(WorkSuitabilities_Set_Work_Suitability);
...
void UWBP_MainMenu_Pal_00_C::OnCloseNameEditWindow(class UPalHUDDispatchParameterBase* Param)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UWBP_MainMenu_Pal_00_C::CustomNavi_ToHPGuide(EUINavigation Navigation)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UWBP_MainMenu_Pal_00_C::CustomNavi_ToFirstPassiveButton(EUINavigation Navigation)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UWBP_MainMenu_Pal_00_C::CustomNavi_ToActiveSkillTop(EUINavigation Navigation)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UPalIndividualCharacterHandle*    targetHandle_BindFromHandle                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UWBP_MainMenu_Pal_00_C::BindFromHandle(class UPalIndividualCharacterHandle* targetHandle_BindFromHandle)
{
	static class UFunction* Func = nullptr;
	...
	Parms.targetHandle_BindFromHandle = targetHandle_BindFromHandle;
