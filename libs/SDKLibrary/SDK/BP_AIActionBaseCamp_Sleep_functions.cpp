...
void UBP_AIActionBaseCamp_Sleep_C::StartSleepAction(class AActor* ControlledPawn)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIActionBaseCamp_Sleep_C", "StartSleepAction");

	Params::BP_AIActionBaseCamp_Sleep_C_StartSleepAction Parms{};
