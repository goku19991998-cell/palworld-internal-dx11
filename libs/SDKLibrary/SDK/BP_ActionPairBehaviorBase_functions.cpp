...
EPalActionType UBP_ActionPairBehaviorBase_C::GetEActionForRideBoss()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionPairBehaviorBase_C", "GetEActionForRideBoss");

	Params::BP_ActionPairBehaviorBase_C_GetEActionForRideBoss Parms{};
