...
void UBP_ArenaSequence_PreBattle_C::FadeIn()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ArenaSequence_PreBattle_C", "FadeIn");
...
void UBP_ArenaSequence_PreBattle_C::SetDisableLocalPlayerInput(bool isDisable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ArenaSequence_PreBattle_C", "SetDisableLocalPlayerInput");

	Params::BP_ArenaSequence_PreBattle_C_SetDisableLocalPlayerInput Parms{};
...
// Function BP_ArenaSequence_PreBattle.BP_ArenaSequence_PreBattle_C.カスタムイベント
// (BlueprintCallable, BlueprintEvent)

void UBP_ArenaSequence_PreBattle_C::カスタムイベント()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ArenaSequence_PreBattle_C", "カスタムイベント");
