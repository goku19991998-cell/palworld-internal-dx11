...
void IBP_AIController_Interface_Invader_C::BindOnInvaderArrivedDelegate(TDelegate<void()> Event)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIController_Interface_Invader_C", "BindOnInvaderArrivedDelegate");
...
void IBP_AIController_Interface_Invader_C::OnInvaderArrived()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BP_AIController_Interface_Invader_C", "OnInvaderArrived");
