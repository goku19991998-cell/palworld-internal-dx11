...
{
public:
	class UPalItemContainer*                      Container_OnUpdateInventory;                       // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
