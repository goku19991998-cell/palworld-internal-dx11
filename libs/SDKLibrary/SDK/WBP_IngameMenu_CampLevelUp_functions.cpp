...
// Function WBP_IngameMenu_CampLevelUp.WBP_IngameMenu_CampLevelUp_C.SequenceEvent
// (BlueprintCallable, BlueprintEvent)

void UWBP_IngameMenu_CampLevelUp_C::SequenceEvent()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenu_CampLevelUp_C", "SequenceEvent");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WBP_IngameMenu_CampLevelUp.WBP_IngameMenu_CampLevelUp_C.SequenceEvent__ENTRYPOINTWBP_IngameMenu_CampLevelUp
// (Public, BlueprintCallable, BlueprintEvent)

void UWBP_IngameMenu_CampLevelUp_C::SequenceEvent__ENTRYPOINTWBP_IngameMenu_CampLevelUp()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenu_CampLevelUp_C", "SequenceEvent__ENTRYPOINTWBP_IngameMenu_CampLevelUp");
