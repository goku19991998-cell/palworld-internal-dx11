...
// Function BP_Action_NPC_MeleeAttack.BP_Action_NPC_MeleeAttack_C.OnEndAction
// (Event, Public, BlueprintEvent)

void UBP_Action_NPC_MeleeAttack_C::OnEndAction()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Action_NPC_MeleeAttack_C", "OnEndAction");
