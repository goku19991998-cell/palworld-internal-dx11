...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UPalHUDDispatchParameter_FadeWidget*FadeParameter_Setup                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UWBP_InLevelLoadingFade_C::Setup(class UPalHUDDispatchParameter_FadeWidget* FadeParameter_Setup)
{
	static class UFunction* Func = nullptr;
	...
	Parms.FadeParameter_Setup = FadeParameter_Setup;
