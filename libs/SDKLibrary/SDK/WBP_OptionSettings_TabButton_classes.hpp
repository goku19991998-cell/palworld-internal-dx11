...
public:
	...
	TMulticastInlineDelegate<void(int32 Param_Index_0)> SwitchTabTo;                                 // 0x02A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
