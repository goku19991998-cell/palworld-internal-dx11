...
void ABP_PalRandomIncidentSpawner_C::ReceiveDrawDebugShape(float Delta)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PalRandomIncidentSpawner_C", "ReceiveDrawDebugShape");

	Params::BP_PalRandomIncidentSpawner_C_ReceiveDrawDebugShape Parms{};
