...
void ABP_LevelGimmick_AreaBarrier_C::ReceiveTick(float DeltaSeconds_ReceiveTick)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const struct FPalLevelGimmick_AreaBarrier_ViewModel&InViewModel_OnDataChanged                              (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)

void ABP_LevelGimmick_AreaBarrier_C::OnDataChanged(const struct FPalLevelGimmick_AreaBarrier_ViewModel& InViewModel_OnDataChanged)
{
	static class UFunction* Func = nullptr;
	...
	Parms.InViewModel_OnDataChanged = std::move(InViewModel_OnDataChanged);
...
// Parameters:
// TArray<class USceneComponent*>          ReturnValue_GetTeleportPoints                          (Parm, OutParm, ReturnParm, ContainsInstancedReference)
...
TArray<class USceneComponent*> ABP_LevelGimmick_AreaBarrier_C::GetTeleportPoints() const
{
	...
	return Parms.ReturnValue_GetTeleportPoints;
}
