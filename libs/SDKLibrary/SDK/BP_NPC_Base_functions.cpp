...
// Function BP_NPC_Base.BP_NPC_Base_C.OnEnterWater
// (BlueprintCallable, BlueprintEvent)

void ABP_NPC_Base_C::OnEnterWater()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_NPC_Base_C", "OnEnterWater");

	UObject::ProcessEvent(Func, nullptr);
}


// Function BP_NPC_Base.BP_NPC_Base_C.OnExitWater
// (BlueprintCallable, BlueprintEvent)

void ABP_NPC_Base_C::OnExitWater()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_NPC_Base_C", "OnExitWater");
...
// Function BP_NPC_Base.BP_NPC_Base_C.RegisterSwimEvent
// (BlueprintCallable, BlueprintEvent)

void ABP_NPC_Base_C::RegisterSwimEvent()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_NPC_Base_C", "RegisterSwimEvent");
...
// Function BP_NPC_Base.BP_NPC_Base_C.UnregisterSwimEvent
// (BlueprintCallable, BlueprintEvent)

void ABP_NPC_Base_C::UnregisterSwimEvent()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_NPC_Base_C", "UnregisterSwimEvent");
...
void ABP_NPC_Base_C::カスタムイベント_0(class APalCharacter* InCharacter)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_NPC_Base_C_カスタムイベント_0 Parms{};
...
void ABP_NPC_Base_C::カスタムイベント_2(const struct FPalDeadInfo& DeadInfo)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_NPC_Base_C_カスタムイベント_2 Parms{};
