...
void UWBP_Guild_MemberList_C::SetRole(EPalGuildRole Role)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Guild_MemberList_C", "SetRole");

	Params::WBP_Guild_MemberList_C_SetRole Parms{};
