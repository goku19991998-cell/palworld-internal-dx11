...
void UWBP_PalCommonScrollList_C::SetEnableMouseWheelScroll(bool bEnableMouseWheel)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalCommonScrollList_C", "SetEnableMouseWheelScroll");

	Params::WBP_PalCommonScrollList_C_SetEnableMouseWheelScroll Parms{};
