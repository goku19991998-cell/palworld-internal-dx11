...
public:
	...
	struct FEventReply OnPreviewMouseButtonDown(const struct FGeometry& MyGeometry_OnPreviewMouseButtonDown, const struct FPointerEvent& MouseEvent_OnPreviewMouseButtonDown);
