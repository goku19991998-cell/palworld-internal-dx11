...
// Function BP_ActionWakeupFromRagdoll.BP_ActionWakeupFromRagdoll_C.OnEndAction
// (Event, Public, BlueprintEvent)

void UBP_ActionWakeupFromRagdoll_C::OnEndAction()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionWakeupFromRagdoll_C", "OnEndAction");
...
void UBP_ActionWakeupFromRagdoll_C::SetWakeupUpperOverrideDisableFlag(bool bDisable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionWakeupFromRagdoll_C", "SetWakeupUpperOverrideDisableFlag");

	Params::BP_ActionWakeupFromRagdoll_C_SetWakeupUpperOverrideDisableFlag Parms{};
