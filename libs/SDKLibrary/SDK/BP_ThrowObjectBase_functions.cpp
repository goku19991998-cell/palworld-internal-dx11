...
void ABP_ThrowObjectBase_C::SetEffectParam(class UNiagaraComponent* Niagara)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ThrowObjectBase_C", "SetEffectParam");

	Params::BP_ThrowObjectBase_C_SetEffectParam Parms{};
