...
// Parameters:
// const struct FPalBuildObjectData&       BuildObjectData                                        (BlueprintVisible, BlueprintReadOnly, Parm)
// bool*                                   bHasBlueprint                                          (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_IngameMenuConstruction_Radial_C::HasBlueprint(const struct FPalBuildObjectData& BuildObjectData, bool* bHasBlueprint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenuConstruction_Radial_C", "HasBlueprint");

	Params::WBP_IngameMenuConstruction_Radial_C_HasBlueprint Parms{};

	Parms.BuildObjectData = std::move(BuildObjectData);

	UObject::ProcessEvent(Func, &Parms);

	if (bHasBlueprint != nullptr)
		*bHasBlueprint = Parms.bHasBlueprint;
}
...
void UWBP_IngameMenuConstruction_Radial_C::Start_Paint_Mode()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenuConstruction_Radial_C", "Start Paint Mode");
