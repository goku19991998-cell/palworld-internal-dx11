...
// Function BP_AIActionReaction_ElectricShock.BP_AIActionReaction_ElectricShock_C.OnFinishElectricShock
// (Protected, BlueprintCallable, BlueprintEvent)

void UBP_AIActionReaction_ElectricShock_C::OnFinishElectricShock()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIActionReaction_ElectricShock_C", "OnFinishElectricShock");
