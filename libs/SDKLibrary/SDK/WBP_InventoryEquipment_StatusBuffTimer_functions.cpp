...
// Parameters:
// E_PalFoodStatusForStatusBuffTimer       BuffType_0                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// E_PalFoodStatusForStatusBuffTimer       BuffTypeForStatusBuffTimer                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_InventoryEquipment_StatusBuffTimer_C::SetFoodBuff(E_PalFoodStatusForStatusBuffTimer BuffType_0, E_PalFoodStatusForStatusBuffTimer BuffTypeForStatusBuffTimer, bool IsBuff, class UPalIndividualCharacterParameter* individualParam)
{
	static class UFunction* Func = nullptr;
	...
	Parms.BuffType_0 = BuffType_0;
	Parms.BuffTypeForStatusBuffTimer = BuffTypeForStatusBuffTimer;
	Parms.IsBuff = IsBuff;
