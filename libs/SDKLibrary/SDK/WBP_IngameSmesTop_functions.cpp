...
void UWBP_IngameSmesTop_C::On_Player_Level_Up(int32 DisplayLevel)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameSmesTop_C", "On Player Level Up");

	Params::WBP_IngameSmesTop_C_On_Player_Level_Up Parms{};
