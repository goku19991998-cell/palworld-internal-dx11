...
// Parameters:
// TArray<class UPalIndividualCharacterHandle*>*Handles_0                                              (Parm, OutParm)

void ABP_SquadNPCSpawner_C::GetAllSpawnedNPCHandle(TArray<class UPalIndividualCharacterHandle*>* Handles_0)
{
	static class UFunction* Func = nullptr;
	...
	if (Handles_0 != nullptr)
		*Handles_0 = std::move(Parms.Handles_0);
}
...
void ABP_SquadNPCSpawner_C::OnOtomoSpawnedSquad(class AController* HolderController, class APalCharacter* OtomoPal)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SquadNPCSpawner_C", "OnOtomoSpawnedSquad");

	Params::BP_SquadNPCSpawner_C_OnOtomoSpawnedSquad Parms{};
...
void ABP_SquadNPCSpawner_C::SetNullHandleWhenDestoryOtomoSquad(class AActor* DestroyedActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SquadNPCSpawner_C", "SetNullHandleWhenDestoryOtomoSquad");

	Params::BP_SquadNPCSpawner_C_SetNullHandleWhenDestoryOtomoSquad Parms{};
