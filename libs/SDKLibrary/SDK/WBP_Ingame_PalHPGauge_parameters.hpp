...
public:
	...
	TDelegate<void(const struct FFixedPoint& CoolDownTime_0, const struct FFixedPoint& CoolDownTimeMax_0)> K2Node_CreateDelegate_OutputDelegate_2; // 0x003C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	TDelegate<void(const struct FFixedPoint& CoolDownTime_0, const struct FFixedPoint& CoolDownTimeMax_0)> K2Node_CreateDelegate_OutputDelegate_2; // 0x0020(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
