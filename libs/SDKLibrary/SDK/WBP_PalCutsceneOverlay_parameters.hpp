...
public:
	...
	int32                                         K2Node_CustomEvent_SkipCount;                      // 0x0068(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_CustomEvent_TotalCount;                     // 0x006C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPalHUDDispatchParameter_CutsceneOverlay* K2Node_DynamicCast_AsPal_HUDDispatch_Parameter_Cutscene_Overlay; // 0x0070(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(int32 SkipCount, int32 TotalCount)> K2Node_CreateDelegate_OutputDelegate;         // 0x00B8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
DUMPER7_ASSERTS_WBP_PalCutsceneOverlay_C_BP_GetDesiredFocusTarget;
