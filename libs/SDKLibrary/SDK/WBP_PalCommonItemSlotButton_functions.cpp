...
// Parameters:
// class UWBP_PalItemSlotBase_C**          itemSlotWidget_RegisterItemSlotWidget                  (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void UWBP_PalCommonItemSlotButton_C::RegisterItemSlotWidget(class UWBP_PalItemSlotBase_C** itemSlotWidget_RegisterItemSlotWidget)
{
	...
	if (itemSlotWidget_RegisterItemSlotWidget != nullptr)
		*itemSlotWidget_RegisterItemSlotWidget = Parms.itemSlotWidget_RegisterItemSlotWidget;
}
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UCommonButtonBase**               Button_RegisterButton                                  (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void UWBP_PalCommonItemSlotButton_C::RegisterButton(class UCommonButtonBase** Button_RegisterButton)
{
	static class UFunction* Func = nullptr;
	...
	if (Button_RegisterButton != nullptr)
		*Button_RegisterButton = Parms.Button_RegisterButton;
}
