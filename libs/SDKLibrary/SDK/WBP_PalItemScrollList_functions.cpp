...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// int32                                   DisplayContainerSlotNumDefault                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_PalItemScrollList_C::SetDisplayContainerSlotNumDefault(int32 DisplayContainerSlotNumDefault)
{
	static class UFunction* Func = nullptr;
	...
	Parms.DisplayContainerSlotNumDefault = DisplayContainerSlotNumDefault;
