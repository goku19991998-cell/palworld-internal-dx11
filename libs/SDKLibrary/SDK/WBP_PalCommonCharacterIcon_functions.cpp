...
void UWBP_PalCommonCharacterIcon_C::GetCurrentBrush(struct FSlateBrush* CurrentBrush)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalCommonCharacterIcon_C", "GetCurrentBrush");

	Params::WBP_PalCommonCharacterIcon_C_GetCurrentBrush Parms{};
