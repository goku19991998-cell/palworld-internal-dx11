...
// Parameters:
// EPalActionType                          ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

EPalActionType UBP_ActionPairBehavior_FeedItem_C::GetEActionForRideBoss()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionPairBehavior_FeedItem_C", "GetEActionForRideBoss");

	Params::BP_ActionPairBehavior_FeedItem_C_GetEActionForRideBoss Parms{};
