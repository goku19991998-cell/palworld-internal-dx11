...
// bool                                    bSucide                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_GameOver_Defeat_C::SetDeathPenaltyMode(EPalOptionWorldDeathPenalty PenaltyMode, bool bSucide)
{
	static class UFunction* Func = nullptr;
...
// Function WBP_GameOver_Defeat.WBP_GameOver_Defeat_C.BndEvt__WBP_GameOver_Defeat_WBP_CommonButton_SurrenderRaidBossArea_K2Node_ComponentBoundEvent_2_OnClicked__DelegateSignature
// (BlueprintEvent)

void UWBP_GameOver_Defeat_C::BndEvt__WBP_GameOver_Defeat_WBP_CommonButton_SurrenderRaidBossArea_K2Node_ComponentBoundEvent_2_OnClicked__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GameOver_Defeat_C", "BndEvt__WBP_GameOver_Defeat_WBP_CommonButton_SurrenderRaidBossArea_K2Node_ComponentBoundEvent_2_OnClicked__DelegateSignature");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WBP_GameOver_Defeat.WBP_GameOver_Defeat_C.BndEvt__WBP_GameOver_Defeat_WBP_CommonButton_RecreateCharacter_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature
// (BlueprintEvent)

void UWBP_GameOver_Defeat_C::BndEvt__WBP_GameOver_Defeat_WBP_CommonButton_RecreateCharacter_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GameOver_Defeat_C", "BndEvt__WBP_GameOver_Defeat_WBP_CommonButton_RecreateCharacter_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature");
...
// Function WBP_GameOver_Defeat.WBP_GameOver_Defeat_C.ActivateSurrenderRaidBossArea
// (Public, BlueprintCallable, BlueprintEvent)

void UWBP_GameOver_Defeat_C::ActivateSurrenderRaidBossArea()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GameOver_Defeat_C", "ActivateSurrenderRaidBossArea");
