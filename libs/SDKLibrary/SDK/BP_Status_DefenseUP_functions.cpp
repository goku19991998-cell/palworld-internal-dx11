...
// Function BP_Status_DefenseUP.BP_Status_DefenseUP_C.OnBeginSomeStatus
// (Event, Public, BlueprintEvent)

void UBP_Status_DefenseUP_C::OnBeginSomeStatus()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Status_DefenseUP_C", "OnBeginSomeStatus");
...
// Function BP_Status_DefenseUP.BP_Status_DefenseUP_C.SetupStatus
// (BlueprintCallable, BlueprintEvent)

void UBP_Status_DefenseUP_C::SetupStatus()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Status_DefenseUP_C", "SetupStatus");
