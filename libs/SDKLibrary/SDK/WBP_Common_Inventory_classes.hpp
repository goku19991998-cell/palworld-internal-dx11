...
public:
	...
	TMulticastInlineDelegate<void(class UWBP_PalItemSlotButtonBase_C* Slot_0, EPalItemSlotPressType PressType)> OnLeftClickSlot; // 0x02D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UWBP_PalItemSlotButtonBase_C* Slot_0, EPalItemSlotPressType PressType)> OnRightClickSlot; // 0x02E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
