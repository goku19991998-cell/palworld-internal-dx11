...
void ABP_MonoNPCSpawner_C::Initialize_Spawned_Character(class UPalIndividualCharacterHandle* Handle, class UClass* DefaultAction, const struct FF_NPC_PathWalkArray& WalkPath, class FName Otomo, bool AdjustToFloor)
{
	static class UFunction* Func = nullptr;
