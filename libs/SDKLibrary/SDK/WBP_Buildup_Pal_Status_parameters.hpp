...
public:
	...
	TDelegate<void(EPalCharacterStatusOperationName Status_0, int32 TargetRank_0)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0080(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
