...
struct BP_MapObject_DamagableRock0017_C_ExecuteUbergraph_BP_MapObject_DamagableRock0017 final
{
public:
...
{
public:
	bool                                          ReturnValue_IsShowOutlineInReticleTargetting;      // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
