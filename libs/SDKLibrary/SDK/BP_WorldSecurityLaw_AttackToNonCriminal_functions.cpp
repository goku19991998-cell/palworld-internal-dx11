...
void UBP_WorldSecurityLaw_AttackToNonCriminal_C::GetAttacker(const struct FPalDamageResult& DamageResult, class AActor** Attacker)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WorldSecurityLaw_AttackToNonCriminal_C", "GetAttacker");

	Params::BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker Parms{};
