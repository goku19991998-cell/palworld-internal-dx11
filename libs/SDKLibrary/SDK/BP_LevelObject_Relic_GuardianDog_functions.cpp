...
#include "BP_LevelObject_Relic_GuardianDog_classes.hpp"
#include "BP_LevelObject_Relic_GuardianDog_parameters.hpp"
...
void ABP_LevelObject_Relic_GuardianDog_C::OnUpdatePickupStatus(class APalLevelObjectObtainable* LevelObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_LevelObject_Relic_GuardianDog_C", "OnUpdatePickupStatus");

	Params::BP_LevelObject_Relic_GuardianDog_C_OnUpdatePickupStatus Parms{};
...
struct FVector ABP_LevelObject_Relic_GuardianDog_C::GetObtainFXLocation() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_LevelObject_Relic_GuardianDog_C", "GetObtainFXLocation");

	Params::BP_LevelObject_Relic_GuardianDog_C_GetObtainFXLocation Parms{};
