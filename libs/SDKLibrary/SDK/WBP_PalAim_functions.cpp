...
// Parameters:
// const struct FPalItemId&                WeaponItemId                                           (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)
// bool*                                   bActivated                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_PalAim_C::ActivateAdditionalWidget(const struct FPalItemId& WeaponItemId, bool* bActivated)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalAim_C", "ActivateAdditionalWidget");

	Params::WBP_PalAim_C_ActivateAdditionalWidget Parms{};
...
// Function WBP_PalAim.WBP_PalAim_C.InitializeReticleMap
// (BlueprintCallable, BlueprintEvent)

void UWBP_PalAim_C::InitializeReticleMap()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalAim_C", "InitializeReticleMap");
...
void UWBP_PalAim_C::UpdateFishingReticle()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalAim_C", "UpdateFishingReticle");
