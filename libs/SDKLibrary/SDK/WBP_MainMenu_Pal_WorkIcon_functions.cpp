...
// Parameters:
// bool                                    bBoosted                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_MainMenu_Pal_WorkIcon_C::SetBoostedDetail(bool bBoosted)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MainMenu_Pal_WorkIcon_C", "SetBoostedDetail");

	Params::WBP_MainMenu_Pal_WorkIcon_C_SetBoostedDetail Parms{};

	Parms.bBoosted = bBoosted;
...
void UWBP_MainMenu_Pal_WorkIcon_C::SetExistsRequiredWorker(bool bOn)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MainMenu_Pal_WorkIcon_C", "SetExistsRequiredWorker");

	Params::WBP_MainMenu_Pal_WorkIcon_C_SetExistsRequiredWorker Parms{};
...
void UWBP_MainMenu_Pal_WorkIcon_C::SetRankBonusDetail(bool bEnable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MainMenu_Pal_WorkIcon_C", "SetRankBonusDetail");

	Params::WBP_MainMenu_Pal_WorkIcon_C_SetRankBonusDetail Parms{};
