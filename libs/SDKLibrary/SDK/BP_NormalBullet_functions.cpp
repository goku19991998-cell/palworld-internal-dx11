...
void ABP_NormalBullet_C::SelectHitEffect(class UNiagaraSystem** NewParam)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_NormalBullet_C", "SelectHitEffect");

	Params::BP_NormalBullet_C_SelectHitEffect Parms{};
