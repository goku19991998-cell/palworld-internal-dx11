...
void UWBP_DebugItemSearchWindow_C::OnClickedSlotInternal(class UWBP_PalItemSlotButtonBase_C* Slot)
{
	static class UFunction* Func = nullptr;
...
void UWBP_DebugItemSearchWindow_C::BndEvt__WBP_DebugItemSearchWindow_WBP_IngameMenu_ItemSearchList_K2Node_ComponentBoundEvent_0_OnRightClickSlot__DelegateSignature(class UWBP_PalItemSlotButtonBase_C* Slot, EPalItemSlotPressType PressType)
{
	static class UFunction* Func = nullptr;
