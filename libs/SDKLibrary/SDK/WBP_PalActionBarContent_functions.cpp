...
void UWBP_PalActionBarContent_C::HoveredEvent(class UCommonButtonBase* Button)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalActionBarContent_C", "HoveredEvent");

	Params::WBP_PalActionBarContent_C_HoveredEvent Parms{};
