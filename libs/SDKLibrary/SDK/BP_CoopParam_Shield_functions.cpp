...
void UBP_CoopParam_Shield_C::SetDisableMovement(bool Disabled)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_CoopParam_Shield_C", "SetDisableMovement");

	Params::BP_CoopParam_Shield_C_SetDisableMovement Parms{};
