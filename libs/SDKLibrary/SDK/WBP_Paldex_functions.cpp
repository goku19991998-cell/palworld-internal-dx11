...
void UWBP_Paldex_C::ScrollByPanelIndex(int32 ScrollByPanelIndex)
{
	static class UFunction* Func = nullptr;
...
void UWBP_Paldex_C::PageSkip_Up(EUINavigation Navigation)
{
	static class UFunction* Func = nullptr;
...
void UWBP_Paldex_C::PageSkip_Down(EUINavigation Navigation)
{
	static class UFunction* Func = nullptr;
