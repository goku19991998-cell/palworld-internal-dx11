...
void UBP_PalSupplyIncident_C::CreateGroupRequestParams(TArray<struct FPalRandomIncidentGroupRequestParameter>* RequestParams)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PalSupplyIncident_C", "CreateGroupRequestParams");

	Params::BP_PalSupplyIncident_C_CreateGroupRequestParams Parms{};
...
// Function BP_PalSupplyIncident.BP_PalSupplyIncident_C.OnCanceled
// (Event, Public, BlueprintEvent)

void UBP_PalSupplyIncident_C::OnCanceled()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PalSupplyIncident_C", "OnCanceled");
