...
public:
	...
	TMulticastInlineDelegate<void(class UWBP_CharaCre_BodyTypeButton_C* Widget)> OnClicked;          // 0x02C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FDataTableRowHandle                    VoiceMsgID;                                        // 0x02D8(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	TMulticastInlineDelegate<void(class UWBP_CharaCre_BodyTypeButton_C* Widget)> OnHovered;          // 0x02E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("WBP_CharaCre_BodyTypeButton_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"WBP_CharaCre_BodyTypeButton_C")
	}
...
DUMPER7_ASSERTS_UWBP_CharaCre_BodyTypeButton_C;
