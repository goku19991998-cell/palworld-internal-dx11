...
void UWBP_Map_IconPlayer_C::SetupForceVisibility(bool* bChangedVisibility_SetupForceVisibility)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct FVector*                         LocationPosition_GetLocationPosition                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_Map_IconPlayer_C::GetLocationPosition(struct FVector* LocationPosition_GetLocationPosition)
{
	static class UFunction* Func = nullptr;
	...
	if (LocationPosition_GetLocationPosition != nullptr)
		*LocationPosition_GetLocationPosition = std::move(Parms.LocationPosition_GetLocationPosition);
}
