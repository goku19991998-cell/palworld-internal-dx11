...
void UWBP_Ingame_Interact_C::Set_Action_Type(EPalInteractiveObjectActionType ActionType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Ingame_Interact_C", "Set Action Type");

	Params::WBP_Ingame_Interact_C_Set_Action_Type Parms{};
