...
void UWBP_PalKeyGuideIcon_C::OnUISettingChanged(const struct FPalOptionUISettings& PrevSettings, const struct FPalOptionUISettings& NewSettings)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalKeyGuideIcon_C", "OnUISettingChanged");

	Params::WBP_PalKeyGuideIcon_C_OnUISettingChanged Parms{};
...
void UWBP_PalKeyGuideIcon_C::PreConstruct(bool IsDesignTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalKeyGuideIcon_C", "PreConstruct");

	Params::WBP_PalKeyGuideIcon_C_PreConstruct Parms{};
