...
public:
	...
	TDelegate<void(float RemainingTime, float CoolDownTime_0)> K2Node_CreateDelegate_OutputDelegate; // 0x0008(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	TDelegate<void(float RemainingTime, float CoolDownTime_0)> K2Node_CreateDelegate_OutputDelegate_2; // 0x0020(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
