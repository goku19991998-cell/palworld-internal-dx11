...
// Parameters:
// EPalHumanStunType                       StunType                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool*                                   StunSuccess                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_AIADamageReaction_C::CheckHumanStun(EPalHumanStunType StunType, const struct FVector& BlowVelocity, bool* StunSuccess)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIADamageReaction_C", "CheckHumanStun");

	Params::BP_AIADamageReaction_C_CheckHumanStun Parms{};
	...
	if (StunSuccess != nullptr)
		*StunSuccess = Parms.StunSuccess;
}
