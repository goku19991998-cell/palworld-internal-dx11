...
void UWBP_Map_Base_C::Tick(const struct FGeometry& MyGeometry_Tick, float InDeltaTime_Tick)
{
	static class UFunction* Func = nullptr;
...
struct FEventReply UWBP_Map_Base_C::OnMouseButtonDown(const struct FGeometry& MyGeometry_OnMouseButtonDown, const struct FPointerEvent& MouseEvent_OnMouseButtonDown)
{
	static class UFunction* Func = nullptr;
...
struct FEventReply UWBP_Map_Base_C::OnKeyDown(const struct FGeometry& MyGeometry_OnKeyDown, const struct FKeyEvent& InKeyEvent_OnKeyDown)
{
	static class UFunction* Func = nullptr;
