...
public:
	...
	TMulticastInlineDelegate<void(bool CanBattle, class UPalIndividualCharacterSlot* Slot_0)> OnChangedBattleModeSetting; // 0x0320(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
