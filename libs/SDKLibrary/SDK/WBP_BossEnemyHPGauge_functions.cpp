...
void UWBP_BossEnemyHPGauge_C::Tick(const struct FGeometry& MyGeometry_Tick, float InDeltaTime_Tick)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class APalCharacter*                    TargetCharacter_SetTargetCharacter                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UWBP_BossEnemyHPGauge_C::SetTargetCharacter(class APalCharacter* TargetCharacter_SetTargetCharacter)
{
	static class UFunction* Func = nullptr;
	...
	Parms.TargetCharacter_SetTargetCharacter = TargetCharacter_SetTargetCharacter;
