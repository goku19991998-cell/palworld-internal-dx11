...
void UWBP_PalBuildObjectList_ForDisplay_C::Tick(const struct FGeometry& MyGeometry_Tick, float InDeltaTime_Tick)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const struct FGeometry&                 MyGeometry_OnPreviewMouseButtonDown                    (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
// const struct FPointerEvent&             MouseEvent_OnPreviewMouseButtonDown                    (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// struct FEventReply                      ReturnValue_OnPreviewMouseButtonDown                   (Parm, OutParm, ReturnParm)

struct FEventReply UWBP_PalBuildObjectList_ForDisplay_C::OnPreviewMouseButtonDown(const struct FGeometry& MyGeometry_OnPreviewMouseButtonDown, const struct FPointerEvent& MouseEvent_OnPreviewMouseButtonDown)
{
	static class UFunction* Func = nullptr;
	...
	Parms.MyGeometry_OnPreviewMouseButtonDown = std::move(MyGeometry_OnPreviewMouseButtonDown);
	Parms.MouseEvent_OnPreviewMouseButtonDown = std::move(MouseEvent_OnPreviewMouseButtonDown);

	UObject::ProcessEvent(Func, &Parms);

	return Parms.ReturnValue_OnPreviewMouseButtonDown;
}
...
struct FEventReply UWBP_PalBuildObjectList_ForDisplay_C::OnMouseWheel(const struct FGeometry& MyGeometry_OnMouseWheel, const struct FPointerEvent& MouseEvent_OnMouseWheel)
{
	static class UFunction* Func = nullptr;
