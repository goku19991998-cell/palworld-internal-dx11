...
void UWBP_PalCharacterScrollList_C::OnEmptySlot_Internal(class UWBP_PalCharacterSlotButtonBase_C* SlotButton)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalCharacterScrollList_C", "OnEmptySlot_Internal");

	Params::WBP_PalCharacterScrollList_C_OnEmptySlot_Internal Parms{};
...
void UWBP_PalCharacterScrollList_C::OnSlotSynced_Internal(class UWBP_PalCharacterSlotButtonBase_C* SelfButton)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalCharacterScrollList_C", "OnSlotSynced_Internal");

	Params::WBP_PalCharacterScrollList_C_OnSlotSynced_Internal Parms{};
