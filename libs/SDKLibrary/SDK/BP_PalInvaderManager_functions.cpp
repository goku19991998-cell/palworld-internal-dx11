...
void UBP_PalInvaderManager_C::BroadcastInvaderArrived(const struct FPalIncidentBroadcastParameter& Parameter)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PalInvaderManager_C", "BroadcastInvaderArrived");

	Params::BP_PalInvaderManager_C_BroadcastInvaderArrived Parms{};
