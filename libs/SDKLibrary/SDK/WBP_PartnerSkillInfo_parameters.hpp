...
public:
	...
	TDelegate<void(const struct FFixedPoint& CoolDownTime_0, const struct FFixedPoint& CoolDownTimeMax_0)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0014(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const struct FFixedPoint& EffectTime_0, const struct FFixedPoint& effectTimeMax_0)> K2Node_CreateDelegate_OutputDelegate_5; // 0x0078(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
