...
#include "BP_PalFirePointLightComponent_classes.hpp"
#include "BP_PalFirePointLightComponent_parameters.hpp"
...
void UBP_PalFirePointLightComponent_C::ReceiveTick(float DeltaSeconds_ReceiveTick)
{
	static class UFunction* Func = nullptr;
