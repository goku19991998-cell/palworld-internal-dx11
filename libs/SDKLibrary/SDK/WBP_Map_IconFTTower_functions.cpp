...
void UWBP_Map_IconFTTower_C::Setup_Internal(class UPalLocationPoint* LocationPoint_Setup_Internal)
{
...
void UWBP_Map_IconFTTower_C::SetEnable(bool Enable_SetEnable)
{
	static class UFunction* Func = nullptr;
...
void UWBP_Map_IconFTTower_C::GetInvisibleButton(class UWidget** Button_GetInvisibleButton)
{
	static class UFunction* Func = nullptr;
