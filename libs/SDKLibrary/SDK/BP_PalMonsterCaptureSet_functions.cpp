...
void ABP_PalMonsterCaptureSet_C::ReceiveTick(float DeltaSeconds_ReceiveTick)
{
	static class UFunction* Func = nullptr;
...
void ABP_PalMonsterCaptureSet_C::ReceiveEndPlay(EEndPlayReason EndPlayReason_ReceiveEndPlay)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// const TSubclassOf<class AActor>&        TargetActorClass                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, UObjectWrapper, HasGetValueTypeHash)

void ABP_PalMonsterCaptureSet_C::PlayAnimation(const TSubclassOf<class AActor>& TargetActorClass)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PalMonsterCaptureSet_C", "PlayAnimation");

	Params::BP_PalMonsterCaptureSet_C_PlayAnimation Parms{};
