...
// Parameters:
// const struct FGuid&                     PlayerUId_OnUpdatedMemberInfo                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const struct FPalUIGuildMemberDisplayInfo&PlayerInfo_OnUpdatedMemberInfo                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UWBP_Guild_ForDisplay_C::OnUpdatedMemberInfo(const struct FGuid& PlayerUId_OnUpdatedMemberInfo, const struct FPalUIGuildMemberDisplayInfo& PlayerInfo_OnUpdatedMemberInfo)
{
	static class UFunction* Func = nullptr;
	...
	Parms.PlayerUId_OnUpdatedMemberInfo = std::move(PlayerUId_OnUpdatedMemberInfo);
	Parms.PlayerInfo_OnUpdatedMemberInfo = std::move(PlayerInfo_OnUpdatedMemberInfo);
...
// Parameters:
// const class FString&                    NewGuildName_OnUpdatedGuildName                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)

void UWBP_Guild_ForDisplay_C::OnUpdatedGuildName(const class FString& NewGuildName_OnUpdatedGuildName)
{
	static class UFunction* Func = nullptr;
	...
	Parms.NewGuildName_OnUpdatedGuildName = std::move(NewGuildName_OnUpdatedGuildName);
...
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
// const struct FGuid&                     PlayerUId_OnRemovedMemberInfo                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_Guild_ForDisplay_C::OnRemovedMemberInfo(const struct FGuid& PlayerUId_OnRemovedMemberInfo)
{
	static class UFunction* Func = nullptr;
	...
	Parms.PlayerUId_OnRemovedMemberInfo = std::move(PlayerUId_OnRemovedMemberInfo);
