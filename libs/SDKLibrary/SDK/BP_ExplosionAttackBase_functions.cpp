...
void ABP_ExplosionAttackBase_C::GetHumanStunType(EPalHumanStunType* HumanStunType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ExplosionAttackBase_C", "GetHumanStunType");

	Params::BP_ExplosionAttackBase_C_GetHumanStunType Parms{};
...
// bool                                    IsPartnerSkill                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_ExplosionAttackBase_C::SetPower(int32 NewParam, double SnakeRate, double PvPDamageRate, double PvPBuildingDamageRate, double PvPPlayerToGuildPalDamageRate_0, bool IsPartnerSkill)
{
	static class UFunction* Func = nullptr;
	...
	Parms.IsPartnerSkill = IsPartnerSkill;
