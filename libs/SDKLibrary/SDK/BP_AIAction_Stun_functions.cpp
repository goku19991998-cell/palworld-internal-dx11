...
void UBP_AIAction_Stun_C::ActionFinished(class APawn* ControlledPawn, EPawnActionResult WithResult)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_Stun_C", "ActionFinished");

	Params::BP_AIAction_Stun_C_ActionFinished Parms{};
