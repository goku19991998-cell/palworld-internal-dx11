...
void UBP_AIAction_Visitor_TravelToBaseCamp_C::Sight_Check_and_Response(EPalAIResponseType Current, bool OverrideIsDamage, bool* ChangeNextAction)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_Visitor_TravelToBaseCamp_C", "Sight Check and Response");

	Params::BP_AIAction_Visitor_TravelToBaseCamp_C_Sight_Check_and_Response Parms{};
