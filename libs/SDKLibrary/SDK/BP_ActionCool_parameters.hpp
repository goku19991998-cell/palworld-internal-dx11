...
struct BP_ActionCool_C_ExecuteUbergraph_BP_ActionCool final
{
public:
	...
	class ABP_Prop_Uchiwa_C*                      CallFunc_FinishSpawningActor_ReturnValue;          // 0x0078(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_BP_ActionCool_C_ExecuteUbergraph_BP_ActionCool;
