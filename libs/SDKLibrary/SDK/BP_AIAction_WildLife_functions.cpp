...
void UBP_AIAction_WildLife_C::CancelAsyncFollowMoveIfAny()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_WildLife_C", "CancelAsyncFollowMoveIfAny");
...
void UBP_AIAction_WildLife_C::IssueAsyncFollowMove(const struct FVector& Goal)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_WildLife_C", "IssueAsyncFollowMove");

	Params::BP_AIAction_WildLife_C_IssueAsyncFollowMove Parms{};
...
void UBP_AIAction_WildLife_C::IsValidFollowMoveGoal(const struct FVector& Goal, bool* IsValid)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_WildLife_C", "IsValidFollowMoveGoal");

	Params::BP_AIAction_WildLife_C_IsValidFollowMoveGoal Parms{};
...
void UBP_AIAction_WildLife_C::OnSightCheckAsyncCompleted(bool bIncludedPlayer, bool bIncludedAliveNPC, bool bIncludedEdibleDeadNPC, const TArray<class APalCharacter*>& InSightCharacters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_WildLife_C", "OnSightCheckAsyncCompleted");

	Params::BP_AIAction_WildLife_C_OnSightCheckAsyncCompleted Parms{};
