...
// WidgetBlueprintGeneratedClass WBP_OptionSettings_MenuButton_S.WBP_OptionSettings_MenuButton_S_C
// 0x0048 (0x02C0 - 0x0278)
class UWBP_OptionSettings_MenuButton_S_C final : public UUserWidget
{
public:
...
public:
	...
	void Construct();
	void ExecuteUbergraph_WBP_OptionSettings_MenuButton_S(int32 EntryPoint);
	void ReleaseFocus();

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("WBP_OptionSettings_MenuButton_S_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"WBP_OptionSettings_MenuButton_S_C")
	}
	static class UWBP_OptionSettings_MenuButton_S_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_OptionSettings_MenuButton_S_C>();
	}
};
DUMPER7_ASSERTS_UWBP_OptionSettings_MenuButton_S_C;
