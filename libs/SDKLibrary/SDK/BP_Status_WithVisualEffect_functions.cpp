...
void UBP_Status_WithVisualEffect_C::カスタムイベント_Dead(const struct FPalDeadInfo& DeadInfo)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_Status_WithVisualEffect_C_カスタムイベント_Dead Parms{};
...
void UBP_Status_WithVisualEffect_C::カスタムイベント_OtherStatusAdd(const class UPalStatusComponent* StatusComponent, EPalStatusID statusID_0, class UPalStatusBase* Status)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd Parms{};
