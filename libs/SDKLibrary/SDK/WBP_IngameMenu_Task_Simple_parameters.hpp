...
DUMPER7_ASSERTS_WBP_IngameMenu_Task_Simple_C_AddTaslDetailText;
...
public:
	...
	TArray<class UWBP_IngameMenu_Task_SimpleList_C*> K2Node_MakeArray_Array;                         // 0x0018(0x0010)(ReferenceParm, ContainsInstancedReference)
