...
public:
	...
	TDelegate<void(class FName ActionName_0, const struct FKey& NewKey, EPalKeyConfigCategory InputType_0, EPalKeyConfigAxisFilterType AxisType_0)> K2Node_CreateDelegate_OutputDelegate; // 0x0018(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
