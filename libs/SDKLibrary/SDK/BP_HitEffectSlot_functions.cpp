...
// Parameters:
// const struct FPalDamageInfo&            Info                                                   (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// Parameters:
// const struct FPalDamageInfo&            PalDamageInfo                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// TSoftObjectPtr<class UNiagaraSystem>    OverrideEffect                                         (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)

void UBP_HitEffectSlot_C::Spawn_Elemental_Hit_Effect_Far(EPalElementType Element, const struct FVector& Location, double EffectScale, bool IsPoison, TSoftObjectPtr<class UNiagaraSystem> OverrideEffect)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_HitEffectSlot_C", "Spawn Elemental Hit Effect Far");

	Params::BP_HitEffectSlot_C_Spawn_Elemental_Hit_Effect_Far Parms{};

	Parms.Element = Element;
	Parms.Location = std::move(Location);
	Parms.EffectScale = EffectScale;
	Parms.IsPoison = IsPoison;
	Parms.OverrideEffect = OverrideEffect;
