...
void UBP_AIAction_NPC_Talking_C::GetNPCTalkingActionClass(class UClass** TalkAction)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_NPC_Talking_C", "GetNPCTalkingActionClass");

	Params::BP_AIAction_NPC_Talking_C_GetNPCTalkingActionClass Parms{};
...
void UBP_AIAction_NPC_Talking_C::OnActionStop(class APawn* Pawn)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_NPC_Talking_C", "OnActionStop");

	Params::BP_AIAction_NPC_Talking_C_OnActionStop Parms{};
