...
public:
	...
	void SetupInternal(class APalCharacter* TargetCharacter_SetupInternal);
	...
	void SetSneakBonusFlagInternal(bool isSneak_SetSneakBonusFlagInternal);
	void SetSneakBonusFlag(bool flag);
	void SetIsIntoBall(bool IntoBall);
	void SetCriticalFlag(bool bCritical);
	void SetCriticalCaptureFlagInternal(bool bIsCritical_SetCriticalCaptureFlagInternal);
	void SetCaptureLevelToALL(int32 Level);
	void SetCaptureLevelInternal(int32 Level_SetCaptureLevelInternal);
