...
void UWBP_GuildHeadButton_C::OnRemovedFromFocusPath(const struct FFocusEvent& InFocusEvent_OnRemovedFromFocusPath)
{
	static class UFunction* Func = nullptr;
...
void UWBP_GuildHeadButton_C::OnAddedToFocusPath(const struct FFocusEvent& InFocusEvent_OnAddedToFocusPath)
{
	static class UFunction* Func = nullptr;
