...
public:
	...
	TDelegate<void(class APalCharacter* Otomo, bool IsActive_0)> K2Node_CreateDelegate_OutputDelegate_2; // 0x00C4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
