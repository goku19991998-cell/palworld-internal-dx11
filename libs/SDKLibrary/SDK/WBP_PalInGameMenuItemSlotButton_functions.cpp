...
// Function WBP_PalInGameMenuItemSlotButton.WBP_PalInGameMenuItemSlotButton_C.SetSlotUnlock
// (BlueprintCallable, BlueprintEvent)

void UWBP_PalInGameMenuItemSlotButton_C::SetSlotUnlock()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalInGameMenuItemSlotButton_C", "SetSlotUnlock");
