...
// EPalEggSpecialType                      InEggSpecialType                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FName                             ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

class FName UBP_PalItemIDManager_C::GetStaticItemIdPalEgg(const class UObject* WorldContextObject, const class FName CharacterID, EPalEggSpecialType InEggSpecialType) const
{
	static class UFunction* Func = nullptr;
	...
	Parms.InEggSpecialType = InEggSpecialType;
...
bool UBP_PalItemIDManager_C::IsWorldTreePalEggStaticItemId(const class FName StaticItemId) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PalItemIDManager_C", "IsWorldTreePalEggStaticItemId");

	Params::BP_PalItemIDManager_C_IsWorldTreePalEggStaticItemId Parms{};
