...
void UBP_AIAction_NPC_CombatBase_C::Check_Stack(double InDeltaTime, bool* Stack)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_NPC_CombatBase_C", "Check Stack");

	Params::BP_AIAction_NPC_CombatBase_C_Check_Stack Parms{};
