...
void UPalBossBattleSequence_Ending_C::カスタムイベント(bool bIsSkipped)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PalBossBattleSequence_Ending_C", "カスタムイベント");

	Params::PalBossBattleSequence_Ending_C_カスタムイベント Parms{};
