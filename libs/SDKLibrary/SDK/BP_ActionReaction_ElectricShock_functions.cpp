...
// Function BP_ActionReaction_ElectricShock.BP_ActionReaction_ElectricShock_C.OnWakeup
// (Protected, BlueprintCallable, BlueprintEvent)

void UBP_ActionReaction_ElectricShock_C::OnWakeup()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionReaction_ElectricShock_C", "OnWakeup");
