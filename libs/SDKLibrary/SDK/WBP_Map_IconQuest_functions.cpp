...
void UWBP_Map_IconQuest_C::SetupForceVisibility(bool* bChangedVisibility_SetupForceVisibility)
{
...
void UWBP_Map_IconQuest_C::Setup_Internal(class UPalLocationPoint* LocationPoint_Setup_Internal)
{
	static class UFunction* Func = nullptr;
...
void UWBP_Map_IconQuest_C::GetInvisibleButton(class UWidget** Button_GetInvisibleButton)
{
	static class UFunction* Func = nullptr;
