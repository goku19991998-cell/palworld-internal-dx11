...
void UBP_AIAction_CanCombatBase_C::OnSightCheckAsyncCompleted(bool bIncludedPlayer, bool bIncludedAliveNPC, bool bIncludedEdibleDeadNPC, const TArray<class APalCharacter*>& InSightCharacters)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_CanCombatBase_C", "OnSightCheckAsyncCompleted");

	Params::BP_AIAction_CanCombatBase_C_OnSightCheckAsyncCompleted Parms{};
...
void UBP_AIAction_CanCombatBase_C::Sight_Check(EPalAIResponseType CurrentState, bool OverrideIsDamage, class AActor** Target, EPalAIResponseType* ResponseType)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_CanCombatBase_C", "Sight Check");

	Params::BP_AIAction_CanCombatBase_C_Sight_Check Parms{};
...
void UBP_AIAction_CanCombatBase_C::Sight_Check_and_Response(EPalAIResponseType Current, bool OverrideIsDamage, bool* ChangeNextAction)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_CanCombatBase_C", "Sight Check and Response");

	Params::BP_AIAction_CanCombatBase_C_Sight_Check_and_Response Parms{};
...
void UBP_AIAction_CanCombatBase_C::SightCheckAsync()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_CanCombatBase_C", "SightCheckAsync");
...
void UBP_AIAction_CanCombatBase_C::StartAlertMode(class AActor* TargetActor)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_CanCombatBase_C", "StartAlertMode");

	Params::BP_AIAction_CanCombatBase_C_StartAlertMode Parms{};
