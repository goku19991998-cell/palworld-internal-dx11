...
// Function BP_Action_NPC_MeleeAttackWithGun.BP_Action_NPC_MeleeAttackWithGun_C.OnEndAction
// (Event, Public, BlueprintEvent)

void UBP_Action_NPC_MeleeAttackWithGun_C::OnEndAction()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Action_NPC_MeleeAttackWithGun_C", "OnEndAction");
