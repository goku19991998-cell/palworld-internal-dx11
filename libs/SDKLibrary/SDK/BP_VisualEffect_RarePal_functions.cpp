...
void UBP_VisualEffect_RarePal_C::IsSizeInitialized(bool* IsSizeInitialized_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VisualEffect_RarePal_C", "IsSizeInitialized");

	Params::BP_VisualEffect_RarePal_C_IsSizeInitialized Parms{};
...
void UBP_VisualEffect_RarePal_C::SpawnEffect()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_VisualEffect_RarePal_C", "SpawnEffect");
