...
void UWBP_MapMarker_Win_C::OnRemovedFromFocusPath(const struct FFocusEvent& InFocusEvent_OnRemovedFromFocusPath)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UWBP_MapMarker_Win_C::DoCustomNavigation(EUINavigation Navigation)
{
	static class UFunction* Func = nullptr;
