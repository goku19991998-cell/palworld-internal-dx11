...
public:
	...
	TDelegate<void(class UPalIndividualCharacterSlot* TargetSlot_0)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0048(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
