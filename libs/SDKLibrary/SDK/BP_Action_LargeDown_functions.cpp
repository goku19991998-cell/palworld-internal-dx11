...
void UBP_Action_LargeDown_C::GetDownTime(double* Time)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Action_LargeDown_C", "GetDownTime");

	Params::BP_Action_LargeDown_C_GetDownTime Parms{};
