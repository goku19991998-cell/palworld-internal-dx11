...
void UWBP_MainMenu_PalRarityStar_C::SetRank_Max(bool IsActive)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_MainMenu_PalRarityStar_C", "SetRank_Max");

	Params::WBP_MainMenu_PalRarityStar_C_SetRank_Max Parms{};
