...
public:
	...
	TDelegate<void(const struct FActorInitStateChangedParams& Params_0)> Delegate;                   // 0x0040(0x0010)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	TSoftClassPtr<class UClass>                   actorClass;                                        // 0x0000(0x0030)(Parm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void(const struct FActorInitStateChangedParams& Params_0)> DelegateToRemove;           // 0x0030(0x0010)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
