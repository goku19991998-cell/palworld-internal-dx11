...
DUMPER7_ASSERTS_BP_BuildObject_Wood_DoorWall_C_BP_OnSetConcreteModel;
...
public:
	...
	TDelegate<void(class UPalMapObjectConcreteModelBase* Model, class UPalMapObjectConcreteModelModuleBase* Module)> K2Node_CreateDelegate_OutputDelegate; // 0x0020(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_SetRotateDoor_RotateAngle_ImplicitCast;   // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_BuildObject_Wood_DoorWall_C_ExecuteUbergraph_BP_BuildObject_Wood_DoorWall;
...
DUMPER7_ASSERTS_BP_BuildObject_Wood_DoorWall_C_OnReadySwitchModule;
...
DUMPER7_ASSERTS_BP_BuildObject_Wood_DoorWall_C_OnUpdateSwitchState;
...
DUMPER7_ASSERTS_BP_BuildObject_Wood_DoorWall_C_SetRotateDoor;
...
DUMPER7_ASSERTS_BP_BuildObject_Wood_DoorWall_C_GetStaticMeshComponents;
...
DUMPER7_ASSERTS_BP_BuildObject_Wood_DoorWall_C_GetStaticMeshInfos;
