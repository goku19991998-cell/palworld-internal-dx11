...
{
public:
	class UPalIndividualCharacterHandle*          SpawnHandle_OnSpawnCharacter;                      // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	TArray<struct FPalBossBattleEventBossRushWave> WaveList;                                         // 0x0000(0x0010)(Parm, OutParm)
};
...
{
public:
	bool                                          ReturnValue_IsBossCleared;                         // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
