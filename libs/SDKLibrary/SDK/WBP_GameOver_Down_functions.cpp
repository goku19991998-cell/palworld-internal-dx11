...
// Function WBP_GameOver_Down.WBP_GameOver_Down_C.CencelPartnerSkillReive
// (Public, BlueprintCallable, BlueprintEvent)

void UWBP_GameOver_Down_C::CencelPartnerSkillReive()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GameOver_Down_C", "CencelPartnerSkillReive");
...
void UWBP_GameOver_Down_C::OnCompleteChat()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GameOver_Down_C", "OnCompleteChat");
...
void UWBP_GameOver_Down_C::OnRequestOpenChat()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GameOver_Down_C", "OnRequestOpenChat");
...
void UWBP_GameOver_Down_C::GetDesiredFocusTargetInternal(class UWidget** Widget) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GameOver_Down_C", "GetDesiredFocusTargetInternal");

	Params::WBP_GameOver_Down_C_GetDesiredFocusTargetInternal Parms{};
