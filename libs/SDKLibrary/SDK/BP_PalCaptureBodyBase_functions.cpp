...
// Parameters:
// class APalCharacter*                    TargetCharacter_SetupInternal                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_PalCaptureBodyBase_C::SetupInternal(class APalCharacter* TargetCharacter_SetupInternal)
{
	static class UFunction* Func = nullptr;
	...
	Parms.TargetCharacter_SetupInternal = TargetCharacter_SetupInternal;
...
void ABP_PalCaptureBodyBase_C::SetTargetHandle(class UPalIndividualCharacterHandle* targetHandle)
{
	static class UFunction* Func = nullptr;
...
// (Event, Public, BlueprintEvent)
// Parameters:
// bool                                    isSneak_SetSneakBonusFlagInternal                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_PalCaptureBodyBase_C::SetSneakBonusFlagInternal(bool isSneak_SetSneakBonusFlagInternal)
{
	static class UFunction* Func = nullptr;
	...
	Parms.isSneak_SetSneakBonusFlagInternal = isSneak_SetSneakBonusFlagInternal;
...
// (Event, Public, BlueprintEvent)
// Parameters:
// bool                                    bIsCritical_SetCriticalCaptureFlagInternal             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_PalCaptureBodyBase_C::SetCriticalCaptureFlagInternal(bool bIsCritical_SetCriticalCaptureFlagInternal)
{
	static class UFunction* Func = nullptr;
	...
	Parms.bIsCritical_SetCriticalCaptureFlagInternal = bIsCritical_SetCriticalCaptureFlagInternal;
...
// (Event, Public, BlueprintEvent)
// Parameters:
// int32                                   Level_SetCaptureLevelInternal                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_PalCaptureBodyBase_C::SetCaptureLevelInternal(int32 Level_SetCaptureLevelInternal)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Level_SetCaptureLevelInternal = Level_SetCaptureLevelInternal;
...
void ABP_PalCaptureBodyBase_C::ReceiveTick(float DeltaSeconds_ReceiveTick)
{
	static class UFunction* Func = nullptr;
