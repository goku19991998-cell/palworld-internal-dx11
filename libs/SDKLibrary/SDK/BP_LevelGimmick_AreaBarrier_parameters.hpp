...
{
public:
	struct FPalLevelGimmick_AreaBarrier_ViewModel InViewModel_OnDataChanged;                         // 0x0000(0x000C)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
};
...
{
public:
	TArray<class USceneComponent*>                ReturnValue_GetTeleportPoints;                     // 0x0000(0x0010)(Parm, OutParm, ReturnParm, ContainsInstancedReference)
