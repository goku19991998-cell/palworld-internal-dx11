...
// Function BP_PalGameInstance.BP_PalGameInstance_C.PollingCheckLoadingScreen
// (BlueprintCallable, BlueprintEvent)

void UBP_PalGameInstance_C::PollingCheckLoadingScreen()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PalGameInstance_C", "PollingCheckLoadingScreen");
