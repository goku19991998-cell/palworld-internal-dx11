...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Enable_SetEnable                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_Map_IconTower_C::SetEnable(bool Enable_SetEnable)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Enable_SetEnable = Enable_SetEnable;
...
void UWBP_Map_IconTower_C::GetInvisibleButton(class UWidget** Button_GetInvisibleButton)
{
	static class UFunction* Func = nullptr;
...
bool UWBP_Map_IconTower_C::GetLocationOnLandscape(struct FVector* OutLocation_GetLocationOnLandscape) const
{
	static class UFunction* Func = nullptr;
