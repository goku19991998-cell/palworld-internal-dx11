...
public:
	...
	TMulticastInlineDelegate<void(class FName ActionName_0, const struct FKey& NewKey, EPalKeyConfigCategory InputType_0, EPalKeyConfigAxisFilterType AxisType_0)> OnKeyChanged; // 0x0048(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
