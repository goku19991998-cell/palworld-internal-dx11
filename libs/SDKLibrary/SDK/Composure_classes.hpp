...
public:
	...
	TMulticastInlineDelegate<void(class ACompositingElement* CompElement, class UTexture* Texture, class FName PassName)> OnTransformPassRendered_BP; // 0x0358(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class ACompositingElement* CompElement, class UTexture* Texture)> OnFinalPassRendered_BP; // 0x0368(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
