...
// Parameters:
// EPalUICommonWarningType*                Display_Type                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_CommonWarning_C::GetDisplayType(EPalUICommonWarningType* Display_Type)
{
	static class UFunction* Func = nullptr;
	...
	if (Display_Type != nullptr)
		*Display_Type = Parms.Display_Type;
}
