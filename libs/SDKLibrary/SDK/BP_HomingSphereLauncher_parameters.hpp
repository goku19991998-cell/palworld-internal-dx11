...
public:
	...
	TDelegate<void(EPalPlayerInventoryType inventoryType, int32 Index_0)> K2Node_CreateDelegate_OutputDelegate; // 0x0008(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_Event_bCanShootOnRelease;                   // 0x001D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
