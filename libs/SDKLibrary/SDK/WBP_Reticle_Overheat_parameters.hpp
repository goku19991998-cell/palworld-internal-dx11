...
public:
	...
	TDelegate<void(bool bOverHeated, double HeatValue_0)> K2Node_CreateDelegate_OutputDelegate;      // 0x009C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(bool bOverHeated, double HeatValue_0)> K2Node_CreateDelegate_OutputDelegate_1;    // 0x00AC(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
