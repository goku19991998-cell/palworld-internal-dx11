...
void UWBP_Ingame_PalHPGauge_C::Get_Next_Otomo_Slot(class UPalIndividualCharacterSlot** Slot_0, bool* IsEmpty)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Ingame_PalHPGauge_C", "Get Next Otomo Slot");

	Params::WBP_Ingame_PalHPGauge_C_Get_Next_Otomo_Slot Parms{};
...
void UWBP_Ingame_PalHPGauge_C::Get_Prev_Otomo_Slot(class UPalIndividualCharacterSlot** Slot_0, bool* IsEmpty)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Ingame_PalHPGauge_C", "Get Prev Otomo Slot");

	Params::WBP_Ingame_PalHPGauge_C_Get_Prev_Otomo_Slot Parms{};
...
// Function WBP_Ingame_PalHPGauge.WBP_Ingame_PalHPGauge_C.On Incremented Otomo from Controller
// (Private, BlueprintCallable, BlueprintEvent)

void UWBP_Ingame_PalHPGauge_C::On_Incremented_Otomo_from_Controller()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Ingame_PalHPGauge_C", "On Incremented Otomo from Controller");
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FFixedPoint&               Now                                                    (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
// const struct FFixedPoint&               Max                                                    (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
