...
void UBP_ActionSleep_C::CheckSleepOnSideAndReplaceMontage()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionSleep_C", "CheckSleepOnSideAndReplaceMontage");
...
void UBP_ActionSleep_C::GetSleepLoopMontage(class UAnimMontage** AnimMontage)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionSleep_C", "GetSleepLoopMontage");

	Params::BP_ActionSleep_C_GetSleepLoopMontage Parms{};
...
bool UBP_ActionSleep_C::IsPlayingSleepLoop()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionSleep_C", "IsPlayingSleepLoop");

	Params::BP_ActionSleep_C_IsPlayingSleepLoop Parms{};
...
void UBP_ActionSleep_C::ShouldChangeSleepLoopMontage(bool* Return_Value)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionSleep_C", "ShouldChangeSleepLoopMontage");

	Params::BP_ActionSleep_C_ShouldChangeSleepLoopMontage Parms{};
...
void UBP_ActionSleep_C::UnregisterSleepLoopEffect(class APalCharacter* Character)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_ActionSleep_C", "UnregisterSleepLoopEffect");

	Params::BP_ActionSleep_C_UnregisterSleepLoopEffect Parms{};
