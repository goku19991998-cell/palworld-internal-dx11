...
// Parameters:
// class UPalIndividualCharacterHandle*    SpawnHandle_OnSpawnCharacter                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_BossBattleEvent_WorldTreeMiddleBoss1_Normal_C::OnSpawnCharacter(class UPalIndividualCharacterHandle* SpawnHandle_OnSpawnCharacter)
{
	static class UFunction* Func = nullptr;
	...
	Parms.SpawnHandle_OnSpawnCharacter = SpawnHandle_OnSpawnCharacter;
...
// Parameters:
// TArray<struct FPalBossBattleEventBossRushWave>*WaveList                                               (Parm, OutParm)

void ABP_BossBattleEvent_WorldTreeMiddleBoss1_Normal_C::GetWaveList(TArray<struct FPalBossBattleEventBossRushWave>* WaveList)
{
	static class UFunction* Func = nullptr;
	...
	if (WaveList != nullptr)
		*WaveList = std::move(Parms.WaveList);
}
...
// Parameters:
// bool                                    ReturnValue_IsBossCleared                              (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
bool ABP_BossBattleEvent_WorldTreeMiddleBoss1_Normal_C::IsBossCleared() const
{
	...
	return Parms.ReturnValue_IsBossCleared;
}
