...
static_assert(offsetof(WBP_InventoryEquipment_ItemInfo_C_GetFoodCategoryName, Name_0) == 0x000008, "Member 'WBP_InventoryEquipment_ItemInfo_C_GetFoodCategoryName::Name_0' has a wrong offset!");
