...
static_assert(offsetof(UWBP_Title_DeleteWorldWindow_C, Image_57) == 0x000438, "Member 'UWBP_Title_DeleteWorldWindow_C::Image_57' has a wrong offset!");
static_assert(offsetof(UWBP_Title_DeleteWorldWindow_C, PalEditableTextBox_144) == 0x000440, "Member 'UWBP_Title_DeleteWorldWindow_C::PalEditableTextBox_144' has a wrong offset!");
