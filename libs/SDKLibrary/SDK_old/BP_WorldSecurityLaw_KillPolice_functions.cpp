...
#include "BP_WorldSecurityLaw_KillPolice_classes.hpp"
#include "BP_WorldSecurityLaw_KillPolice_parameters.hpp"
...
bool UBP_WorldSecurityLaw_KillPolice_C::Condition(const struct FPalDeadInfo& DeadInfo, class UPalIndividualCharacterHandle** CriminalHandle)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WorldSecurityLaw_KillPolice_C", "Condition");

	Params::BP_WorldSecurityLaw_KillPolice_C_Condition Parms{};
...
void UBP_WorldSecurityLaw_KillPolice_C::IsPolice(EPalOrganizationType OrganizationType, bool* bCitizen)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WorldSecurityLaw_KillPolice_C", "IsPolice");

	Params::BP_WorldSecurityLaw_KillPolice_C_IsPolice Parms{};
...
void UBP_WorldSecurityLaw_KillPolice_C::IsValidCharacterActor(class AActor* Actor, bool* bValid, class UPalCharacterParameterComponent** CharacterParameter)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WorldSecurityLaw_KillPolice_C", "IsValidCharacterActor");

	Params::BP_WorldSecurityLaw_KillPolice_C_IsValidCharacterActor Parms{};
