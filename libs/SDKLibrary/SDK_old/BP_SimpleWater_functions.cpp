...
void ABP_SimpleWater_C::DeactivateDigArea()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SimpleWater_C", "DeactivateDigArea");
...
void ABP_SimpleWater_C::RemoveDigArea()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SimpleWater_C", "RemoveDigArea");
