...
public:
	...
	struct FPalOptionWorldSettings                CallFunc_GetEditedWorldSetting_WorldSetting;       // 0x0008(0x0178)()
	class UWidget*                                CallFunc_GetFocusTarget_TargetWidget;              // 0x0180(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_CompleteSetting_ReturnValue;              // 0x0188(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_WorldSetting_C_OnClosedSaveSettingDialog) == 0x000190, "Wrong size on WBP_WorldSetting_C_OnClosedSaveSettingDialog");
...
static_assert(offsetof(WBP_WorldSetting_C_OnClosedSaveSettingDialog, CallFunc_GetFocusTarget_TargetWidget) == 0x000180, "Member 'WBP_WorldSetting_C_OnClosedSaveSettingDialog::CallFunc_GetFocusTarget_TargetWidget' has a wrong offset!");
static_assert(offsetof(WBP_WorldSetting_C_OnClosedSaveSettingDialog, CallFunc_CompleteSetting_ReturnValue) == 0x000188, "Member 'WBP_WorldSetting_C_OnClosedSaveSettingDialog::CallFunc_CompleteSetting_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FPalOptionWorldSettings                CallFunc_GetEditedWorldSetting_WorldSetting;       // 0x0010(0x0178)()
	bool                                          CallFunc_CompleteSetting_ReturnValue;              // 0x0188(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_WorldSetting_C_OnClosedStartGameDialog) == 0x000190, "Wrong size on WBP_WorldSetting_C_OnClosedStartGameDialog");
...
static_assert(offsetof(WBP_WorldSetting_C_OnClosedStartGameDialog, CallFunc_CompleteSetting_ReturnValue) == 0x000188, "Member 'WBP_WorldSetting_C_OnClosedStartGameDialog::CallFunc_CompleteSetting_ReturnValue' has a wrong offset!");
...
{
public:
	struct FPalOptionWorldSettings                Option;                                            // 0x0000(0x0178)(BlueprintVisible, BlueprintReadOnly, Parm)
	struct FPalOptionWorldSettings                NewLocalVar_1;                                     // 0x0178(0x0178)(Edit, BlueprintVisible)
	class FString                                 CallFunc_GetWorldName_WorldName;                   // 0x02F0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class UPalGameInstance*                       K2Node_DynamicCast_AsPal_Game_Instance;            // 0x0320(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_WorldSetting_C_StartNewGame) == 0x000330, "Wrong size on WBP_WorldSetting_C_StartNewGame");
...
static_assert(offsetof(WBP_WorldSetting_C_StartNewGame, NewLocalVar_1) == 0x000178, "Member 'WBP_WorldSetting_C_StartNewGame::NewLocalVar_1' has a wrong offset!");
static_assert(offsetof(WBP_WorldSetting_C_StartNewGame, CallFunc_GetWorldName_WorldName) == 0x0002F0, "Member 'WBP_WorldSetting_C_StartNewGame::CallFunc_GetWorldName_WorldName' has a wrong offset!");
static_assert(offsetof(WBP_WorldSetting_C_StartNewGame, CallFunc_GetGameInstance_ReturnValue) == 0x000300, "Member 'WBP_WorldSetting_C_StartNewGame::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_WorldSetting_C_StartNewGame, K2Node_DynamicCast_AsBP_Pal_Game_Instance) == 0x000308, "Member 'WBP_WorldSetting_C_StartNewGame::K2Node_DynamicCast_AsBP_Pal_Game_Instance' has a wrong offset!");
static_assert(offsetof(WBP_WorldSetting_C_StartNewGame, K2Node_DynamicCast_bSuccess) == 0x000310, "Member 'WBP_WorldSetting_C_StartNewGame::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_WorldSetting_C_StartNewGame, CallFunc_GetGameInstance_ReturnValue_1) == 0x000318, "Member 'WBP_WorldSetting_C_StartNewGame::CallFunc_GetGameInstance_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_WorldSetting_C_StartNewGame, K2Node_DynamicCast_AsPal_Game_Instance) == 0x000320, "Member 'WBP_WorldSetting_C_StartNewGame::K2Node_DynamicCast_AsPal_Game_Instance' has a wrong offset!");
static_assert(offsetof(WBP_WorldSetting_C_StartNewGame, K2Node_DynamicCast_bSuccess_1) == 0x000328, "Member 'WBP_WorldSetting_C_StartNewGame::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
