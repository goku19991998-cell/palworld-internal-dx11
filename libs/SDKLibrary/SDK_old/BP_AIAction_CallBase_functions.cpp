...
void UBP_AIAction_CallBase_C::CanCoopPlayer(bool* CanCoop)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AIAction_CallBase_C", "CanCoopPlayer");

	Params::BP_AIAction_CallBase_C_CanCoopPlayer Parms{};
