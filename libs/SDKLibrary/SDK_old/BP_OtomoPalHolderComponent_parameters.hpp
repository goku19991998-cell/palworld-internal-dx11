...
static_assert(offsetof(BP_OtomoPalHolderComponent_C_GetAIClass, Class_0) == 0x000000, "Member 'BP_OtomoPalHolderComponent_C_GetAIClass::Class_0' has a wrong offset!");
