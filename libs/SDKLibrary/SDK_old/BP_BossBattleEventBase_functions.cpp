...
void ABP_BossBattleEventBase_C::ActivateCharacter(class UPalIndividualCharacterHandle* IndividualHandle, const struct FVector& Offset)
{
...
void ABP_BossBattleEventBase_C::ActivateCharacterByLocation(class UPalIndividualCharacterHandle* IndividualHandle, const struct FVector& Location)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_BossBattleEventBase_C", "ActivateCharacterByLocation");

	Params::BP_BossBattleEventBase_C_ActivateCharacterByLocation Parms{};
...
void ABP_BossBattleEventBase_C::ExecuteUbergraph_BP_BossBattleEventBase(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
...
void ABP_BossBattleEventBase_C::GetDebugNo(int32 BitFlag, bool* Result)
{
	static class UFunction* Func = nullptr;
...
void ABP_BossBattleEventBase_C::OnTerminate()
{
	static class UFunction* Func = nullptr;
...
void ABP_BossBattleEventBase_C::SetSpawner(class ABP_BossBattle_BossCharacterSpawner_C* Spawner)
{
	static class UFunction* Func = nullptr;
