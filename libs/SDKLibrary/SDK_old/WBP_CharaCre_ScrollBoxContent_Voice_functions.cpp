...
void UWBP_CharaCre_ScrollBoxContent_Voice_C::OnHoveredVoiceButton__DelegateSignature(int32 VoiceID)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CharaCre_ScrollBoxContent_Voice_C", "OnHoveredVoiceButton__DelegateSignature");

	Params::WBP_CharaCre_ScrollBoxContent_Voice_C_OnHoveredVoiceButton__DelegateSignature Parms{};
...
void UWBP_CharaCre_ScrollBoxContent_Voice_C::OnHoveredVoiceTypeButton(class UWBP_CharaCre_BodyTypeButton_C* Widget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CharaCre_ScrollBoxContent_Voice_C", "OnHoveredVoiceTypeButton");

	Params::WBP_CharaCre_ScrollBoxContent_Voice_C_OnHoveredVoiceTypeButton Parms{};
...
// Function WBP_CharaCre_ScrollBoxContent_Voice.WBP_CharaCre_ScrollBoxContent_Voice_C.OnUnhoveredVoiceButton__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_CharaCre_ScrollBoxContent_Voice_C::OnUnhoveredVoiceButton__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CharaCre_ScrollBoxContent_Voice_C", "OnUnhoveredVoiceButton__DelegateSignature");

	UObject::ProcessEvent(Func, nullptr);
}


// Function WBP_CharaCre_ScrollBoxContent_Voice.WBP_CharaCre_ScrollBoxContent_Voice_C.OnUnhoveredVoiceTypeButton
// (Public, BlueprintCallable, BlueprintEvent)

void UWBP_CharaCre_ScrollBoxContent_Voice_C::OnUnhoveredVoiceTypeButton()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CharaCre_ScrollBoxContent_Voice_C", "OnUnhoveredVoiceTypeButton");
