...
namespace Offsets
{
	inline int32 GObjects			= 0x94EC210;
	inline int32 AppendString		= 0x34C6150;
	inline int32 GNames				= 0x93F1778;
	inline int32 GWorld				= 0x965AB80;
	inline int32 ProcessEvent		= 0x3644C40;
