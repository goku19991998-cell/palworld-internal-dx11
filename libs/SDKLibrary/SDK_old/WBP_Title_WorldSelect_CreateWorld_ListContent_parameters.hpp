...
static_assert(sizeof(WBP_Title_WorldSelect_CreateWorld_ListContent_C_SetupByLocalWorldDisplayData) == 0x0001E0, "Wrong size on WBP_Title_WorldSelect_CreateWorld_ListContent_C_SetupByLocalWorldDisplayData");
