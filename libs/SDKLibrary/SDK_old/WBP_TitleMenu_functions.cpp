...
// Function WBP_TitleMenu.WBP_TitleMenu_C.BndEvt__WBP_TitleMenu_WBP_Title_MenuButton_EULA_K2Node_ComponentBoundEvent_6_OnClicked__DelegateSignature
// (BlueprintEvent)

void UWBP_TitleMenu_C::BndEvt__WBP_TitleMenu_WBP_Title_MenuButton_EULA_K2Node_ComponentBoundEvent_6_OnClicked__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_TitleMenu_C", "BndEvt__WBP_TitleMenu_WBP_Title_MenuButton_EULA_K2Node_ComponentBoundEvent_6_OnClicked__DelegateSignature");
