...
static_assert(sizeof(UWBP_CharaCre_BodyTypeButton_C) == 0x000308, "Wrong size on UWBP_CharaCre_BodyTypeButton_C");
...
static_assert(offsetof(UWBP_CharaCre_BodyTypeButton_C, OnHovered) == 0x0002E8, "Member 'UWBP_CharaCre_BodyTypeButton_C::OnHovered' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_BodyTypeButton_C, OnUnhovered) == 0x0002F8, "Member 'UWBP_CharaCre_BodyTypeButton_C::OnUnhovered' has a wrong offset!");
