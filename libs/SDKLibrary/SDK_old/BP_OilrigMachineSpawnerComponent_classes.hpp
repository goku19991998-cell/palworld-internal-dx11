...
static_assert(sizeof(UBP_OilrigMachineSpawnerComponent_C) == 0x000108, "Wrong size on UBP_OilrigMachineSpawnerComponent_C");
static_assert(offsetof(UBP_OilrigMachineSpawnerComponent_C, UberGraphFrame) == 0x0000F8, "Member 'UBP_OilrigMachineSpawnerComponent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_OilrigMachineSpawnerComponent_C, Handle) == 0x000100, "Member 'UBP_OilrigMachineSpawnerComponent_C::Handle' has a wrong offset!");
