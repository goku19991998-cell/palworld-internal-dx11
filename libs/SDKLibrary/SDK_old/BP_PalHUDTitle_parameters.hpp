...
public:
	...
	class UClass*                                 K2Node_ClassDynamicCast_AsPal_User_Widget_Stackable_UI; // 0x0030(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FGuid                                  CallFunc_PushWidgetStackableUI_ReturnValue;        // 0x003C(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle) == 0x000050, "Wrong size on BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle");
...
static_assert(offsetof(BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle, CallFunc_GetHUDService_ReturnValue) == 0x000008, "Member 'BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle::CallFunc_GetHUDService_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle, K2Node_CustomEvent_Loaded) == 0x000020, "Member 'BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle::K2Node_CustomEvent_Loaded' has a wrong offset!");
static_assert(offsetof(BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle, Temp_class_Variable) == 0x000028, "Member 'BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle::Temp_class_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle, K2Node_ClassDynamicCast_AsPal_User_Widget_Stackable_UI) == 0x000030, "Member 'BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle::K2Node_ClassDynamicCast_AsPal_User_Widget_Stackable_UI' has a wrong offset!");
static_assert(offsetof(BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle, K2Node_ClassDynamicCast_bSuccess) == 0x000038, "Member 'BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle::K2Node_ClassDynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle, CallFunc_PushWidgetStackableUI_ReturnValue) == 0x00003C, "Member 'BP_PalHUDTitle_C_ExecuteUbergraph_BP_PalHUDTitle::CallFunc_PushWidgetStackableUI_ReturnValue' has a wrong offset!");
