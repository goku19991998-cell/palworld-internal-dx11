...
static_assert(offsetof(BP_NPCEmoteDetectionComponent_C_ActEmote, Class_0) == 0x000000, "Member 'BP_NPCEmoteDetectionComponent_C_ActEmote::Class_0' has a wrong offset!");
