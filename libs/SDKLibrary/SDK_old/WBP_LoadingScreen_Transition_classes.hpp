...
static_assert(offsetof(UWBP_LoadingScreen_Transition_C, FadeIn) == 0x000410, "Member 'UWBP_LoadingScreen_Transition_C::FadeIn' has a wrong offset!");
static_assert(offsetof(UWBP_LoadingScreen_Transition_C, FadeOut) == 0x000418, "Member 'UWBP_LoadingScreen_Transition_C::FadeOut' has a wrong offset!");
