...
static_assert(alignof(BP_ActionCooking_C_ExecuteUbergraph_BP_ActionCooking) == 0x000004, "Wrong alignment on BP_ActionCooking_C_ExecuteUbergraph_BP_ActionCooking");
static_assert(sizeof(BP_ActionCooking_C_ExecuteUbergraph_BP_ActionCooking) == 0x000004, "Wrong size on BP_ActionCooking_C_ExecuteUbergraph_BP_ActionCooking");
