...
public:
	...
	double                                        NPCSetTime;                                        // 0x0158(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UBP_PalTimeManager_C) == 0x000160, "Wrong size on UBP_PalTimeManager_C");
static_assert(offsetof(UBP_PalTimeManager_C, UberGraphFrame) == 0x000150, "Member 'UBP_PalTimeManager_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_PalTimeManager_C, NPCSetTime) == 0x000158, "Member 'UBP_PalTimeManager_C::NPCSetTime' has a wrong offset!");
