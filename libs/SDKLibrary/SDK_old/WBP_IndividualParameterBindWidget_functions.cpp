...
void UWBP_IndividualParameterBindWidget_C::OnUpdateShield__DelegateSignature(const struct FFixedPoint64& NowShield, const struct FFixedPoint64& MaxShield)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IndividualParameterBindWidget_C", "OnUpdateShield__DelegateSignature");

	Params::WBP_IndividualParameterBindWidget_C_OnUpdateShield__DelegateSignature Parms{};
