...
static_assert(sizeof(UBP_PalBossBattleManager_C) == 0x000238, "Wrong size on UBP_PalBossBattleManager_C");
static_assert(offsetof(UBP_PalBossBattleManager_C, UberGraphFrame) == 0x000230, "Member 'UBP_PalBossBattleManager_C::UberGraphFrame' has a wrong offset!");
