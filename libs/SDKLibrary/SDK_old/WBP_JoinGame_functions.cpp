...
void UWBP_JoinGame_C::_____K_e_(class UPalHUDDispatchParameterBase* Param_0)
{
...
void UWBP_JoinGame_C::Passworde__(class UPalHUDDispatchParameterBase* Param_0)
{
	static class UFunction* Func = nullptr;
...
// (BlueprintEvent)
// Parameters:
// class FString                           SearchWord_0                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
