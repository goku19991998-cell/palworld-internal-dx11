...
class UWidget* UWBP_Title_BackupSelect_C::CustomNavi_ToCloseButton(EUINavigation Navigation_0)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UWBP_Title_BackupSelect_C::CustomNavi_ToListTop(EUINavigation Navigation_0)
{
	static class UFunction* Func = nullptr;
