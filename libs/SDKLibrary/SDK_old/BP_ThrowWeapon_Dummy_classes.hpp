...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_ThrowWeapon_Dummy_C;             // 0x05B0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(ABP_ThrowWeapon_Dummy_C) == 0x0005B8, "Wrong size on ABP_ThrowWeapon_Dummy_C");
static_assert(offsetof(ABP_ThrowWeapon_Dummy_C, UberGraphFrame_BP_ThrowWeapon_Dummy_C) == 0x0005B0, "Member 'ABP_ThrowWeapon_Dummy_C::UberGraphFrame_BP_ThrowWeapon_Dummy_C' has a wrong offset!");
