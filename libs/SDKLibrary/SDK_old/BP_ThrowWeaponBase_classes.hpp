...
public:
	...
	FMulticastInlineDelegateProperty_             ThrowEventDispatcher;                              // 0x05A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(ABP_ThrowWeaponBase_C) == 0x0005B0, "Wrong size on ABP_ThrowWeaponBase_C");
static_assert(offsetof(ABP_ThrowWeaponBase_C, UberGraphFrame) == 0x000590, "Member 'ABP_ThrowWeaponBase_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_ThrowWeaponBase_C, DefaultSceneRoot) == 0x000598, "Member 'ABP_ThrowWeaponBase_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ABP_ThrowWeaponBase_C, ThrowEventDispatcher) == 0x0005A0, "Member 'ABP_ThrowWeaponBase_C::ThrowEventDispatcher' has a wrong offset!");
