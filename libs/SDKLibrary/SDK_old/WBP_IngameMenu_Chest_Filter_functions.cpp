...
// Function WBP_IngameMenu_Chest_Filter.WBP_IngameMenu_Chest_Filter_C.OnClickedApplyButton__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_IngameMenu_Chest_Filter_C::OnClickedApplyButton__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_IngameMenu_Chest_Filter_C", "OnClickedApplyButton__DelegateSignature");
