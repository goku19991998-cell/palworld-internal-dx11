...
{
    // g_Console is already created and initialized by initoffsets() (DllMain
    // runs it synchronously before this thread starts) - re-creating it here
    // would leak the first Console's file handles and call AllocConsole again.
#if DEBUG
